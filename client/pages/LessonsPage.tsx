...
import { GraduationCap, Users, Star, MessageSquare } from "lucide-react";
        ...
        <main className="flex-1 overflow-y-auto p-6">
          <div className="mb-6">
            ...
            <p className="text-gray-600">
              Darslarni kuzatish va baholash tizimi
            </p>
          </div>
            ...
            <CardContent>
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">
                  Darslar boshqaruvi ishlab chiqilmoqda
                </h3>
                <p className="text-gray-600 mb-4">
                  Bu yerda darslarni kuzatish, talabalarni baholash va davomat
                  qilish imkoniyatlari bo'ladi
                </p>
