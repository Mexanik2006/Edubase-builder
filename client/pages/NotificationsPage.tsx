      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-6">
          <div className="mb-6">
            ...
            <p className="text-gray-600">Tizim xabarlari va bildirishnomalar</p>
          </div>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center space-x-2">
                ...
                <span>Bildirishnomalar bo'limi</span>
              </CardTitle>
            </CardHeader>
            <CardContent>
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">
                  Bildirishnomalar tizimi ishlab chiqilmoqda
                </h3>
                <p className="text-gray-600 mb-4">
                  Bu yerda tizim xabarlari, xatlar va muhim bildirishnomalar
                  bo'ladi
                </p>
